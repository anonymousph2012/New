				...
				<div class="page-region">
					<div class="page-region-content">
						<div class="row">
							<div class="span4">
								<h2>Subject Name</h2>
								<form method="POST" action ="<?php echo base_url('portal/administrator/subject/modify');?>/<?php echo $subject_info['subject_id']; ?>">
									<div class="input-control text">
										<input type="text" name="subject_name" placeholder="subject_name"value="<?php echo $subject_info['subject_name'];?>">
