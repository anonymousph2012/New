			...
			<div class="page secondary">
				<div class="page-header">
					<div class="page-header-content">
						<h1>Modify Announcement Detail</h1>
					</div>
				</div><!--page-header-->
				<div class="page-region">
					<div class="page-region-content">
						<div class="row">
							<div class="span11">
								<h2>Title</h2>
								 <form method="POST" action ="<?php echo base_url('portal/administrator/announcements/modify/');?>/<?php echo $announcements_info['announcement_id'];?>">
									<div class="input-control text">
										  <input type="text" id="inputTitle" placeholder="Title" name="announcement_title"  value="<?php echo $announcements_info['announcement_title'] ?>">
										<span class="helper"></span>
									</div><!--input control-text-->
									<h2>Content</h2>
										<div class="input-control textarea">
										        <textarea name="announcement_content" rows="10" cols="100" required>
										        	<?php echo $announcements_info['announcement_content'] ?>
										        </textarea>
										</div>
									<br><br>
