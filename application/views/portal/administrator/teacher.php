				...
				<div class="page-region-content">
					...
					<div class="span12">
						<div class="page-control" data-role="page-control">
							<!--tabs-->
							<ul>
								<li class="active"><a href="#frame1">List of Faculty</a></li>
								<li><a href="#frame2">Add a Faculty</a></li>
							</ul>
							<!--tab-content-->
							<div class="frames">
								<div class="frame active" id="frame1">
									...
									<div class="row">
										<div class="span4">
											<form  method="POST" action="<?php echo base_url('portal/administrator/teacher/search');?>">
												<h2>Find Faculty</h2>
						                                 		<div class="input-control text  ">
													<input type="text" name="teacher_id" placeholder="Faculty Number">
										...
										<div class="span11">
											<table class="hovered">
												<thead>
							      					...
							      					<?php foreach ($faculty_profile as $faculty): ?>
							      					<tbody>
							      						<td> <?php echo $faculty['faculty_id'];?> </td>
							      						<td> <?php echo $faculty['faculty_fname'].' '.$faculty['faculty_mname'].' '.$faculty['faculty_lname'];?> </td>
							      						<td> 
							      							<?php echo '<a class="button bg-color-green"href='.base_url().'portal/administrator/teacher/'.$faculty['faculty_id'].'>Update</a>'?>
							      						</td>
							    					</tbody>
							      					<?php endforeach ?>
											</table>
								...
								<div class="frame" id="frame2">
									<form method="POST" action="<?php echo base_url();?>portal/administrator/faculty/add_teacher">
										<div class="offset4">
											<img src="<?php echo base_url('assets/avatar/default_avatar.png');?>"><br>
											<input type="file" name="faculty_profile_pic">
										</div>
										<h2>Faculty Number</h2>
										<div class="input-control text">
											<input type="text" name="faculty_number" placeholder="name" value="<?php echo $teacher_id;?>" >
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Username</h2>
										<div class="input-control text">
											<input type="text" name="faculty_username" placeholder="name">
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Password</h2>
										<div class="input-control text">
											<input type="text" name="faculty_password" placeholder="name">
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>First Name</h2>
										<div class="input-control text">
											<input type="text" name="faculty_first_name" placeholder="First Name">
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Middle Name</h2>
										<div class="input-control text">
											<input type="text" name="faculty_middle_name" placeholder="Middle Name">
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Last Name</h2>
										<div class="input-control text">
											<input type="text" name="faculty_last_name" placeholder="Last Name">
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Address</h2>
										<div class="input-control textarea">
											<textarea rows="5" cols="5" name="faculty_address" style="resize:none;"></textarea>
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Contact Number</h2>
										<div class="input-control text">
											<input type="text" name="faculty_contact_number" placeholder="Contact Number">
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Birth Date</h2>
										<div class="input-control text">
											<input type="text" name="faculty_birth_date" placeholder="Birth Date">
											<span class="helper"></span>
										</div><!--input control-text-->
										<h2>Age</h2>
										<div class="input-control text">
											<input type="text" name="faculty_age" placeholder="Age">
										</div><!--input control-text-->
										<h2>Nationality</h2>
										<div class="input-control text">
											<input type="text" name="faculty_nationality" placeholder="Nationality">
										</div><!--input control-text-->
										<h2>Religion</h2>
										<div class="input-control text">
											<input type="text" name="faculty_religion" placeholder="Religion">
										</div><!--input control-text-->
										<br><br>
