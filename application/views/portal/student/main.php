              ...
              <div class="frames">
                <div class="frame active" id="frame1">
                  ...
                  <?php foreach($announcement as $announcements):?>
                    <legend><a href="<?php echo base_url('portal/student/announcement').'/'.$announcements['announcement_id'];?>"><?php echo $announcements['announcement_title'];?></a></h2> by <?php echo $announcements['administrator_name'];?> </legend>
                    <blockquote>
